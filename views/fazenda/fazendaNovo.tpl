                    ...
                    <div class="card-body">
                        <form  class="form-horizontal" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="area_total" value="{$registro.area_total|default:''}" class="form-control" id="areaTotal" placeholder="Área Total">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="area_util" class="col-sm-2 control-label">Área Útil</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="area_util" value="{$registro.area_util|default:''}" id="areaUtil" placeholder="Área Útil">
                                </div>
                            </div>
                            <div class="form-group">
