                    ...
                    <div class="side-menu-container">
                        <div class="navbar-header">
                            <a class="navbar-brand" href="#">
                                ...
                                <div class="title">SysFazenda</div>
                            </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="panel panel-default dropdown">
                                <a data-toggle="collapse" href="#dropdown-element">
                                    <span class="icon fa fa-folder"></span><span class="title">Cadastros</span>
                                </a>
                                <!-- Dropdown level 1 -->
                            ...
                            <li class="panel panel-default dropdown">
                                <a data-toggle="collapse" href="#dropdown-table">
                                    <span class="icon fa fa-file-pdf-o"></span><span class="title">Relatórios</span>
                                </a>
                                <!-- Dropdown level 1 -->
                            ...
                            <li class="active">
                                <a href="/login/sair">
                                    <span class="icon fa fa-times"></span><span class="title">Sair</span>
                                </a>
                            </li>
                            {*<li class="panel panel-default dropdown">
